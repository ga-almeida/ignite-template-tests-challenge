...
import { TransferOfAmountsBetweenAccountsController } from '../modules/statements/useCases/transferOfAmountsBetweenAccounts/TransferOfAmountsBetweenAccountsController';
...
const transferOfAmountsBetweenAccountsController = new TransferOfAmountsBetweenAccountsController();
...
statementRouter.post('/transfer/:user_id', transferOfAmountsBetweenAccountsController.execute);
